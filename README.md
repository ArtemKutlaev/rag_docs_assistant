...
### Планы на ближайшее будущее.
 ...
 2. Улучшение промпта для нейросети и обработки вопроса пользователя, с учетом его предпочтений(краткий ответ/подробный).
 3. Добавить Docker
 ...
 9. Добавление модуля Computer Vision для обработки записей по фотографиям.
